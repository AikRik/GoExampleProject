...
var books = []book{
	...
	{ID: "3", Title: "War and Peache", Author: "Leo Tolstoy", Quantity: 6},
}
...
func returnBook(c *gin.Context) {
	...
	if err != nil {
		c.IndentedJSON(http.StatusBadRequest, gin.H{"message": "Book does not exist."})

		return
	}

	book.Quantity += 1
	c.IndentedJSON(http.StatusOK, gin.H{"message": "Book check in succesfull."})
}
